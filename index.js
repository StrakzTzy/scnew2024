...
if(usePairingCode && !haikal.authState.creds.registered) {
		const phoneNumber = await question('MASUKAN NOMOR DENGAN AWALAN 62 ABANGKU:\n');
...
require("./starkzkece")(haikal, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
...
connectToWhatsApp();
  ...
  haikal.sendMessage('6285771598591' + "@s.whatsapp.net", { text: `BOT ON YAH BANG BELI PANEL DI BANG rizal-dev BUY SCNYA JUGA DI BANG rizal-dev
